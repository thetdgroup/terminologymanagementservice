...
FuzeIn.TerminologyTemplateForm = function(config) 
{
 this.addEvents({
   "search_event":true
 });
 ...
 FuzeIn.TerminologyTemplateForm.superclass.constructor.call(this, config);
};

//
FuzeIn.TerminologyTemplateForm = Ext.extend(Ext.form.FormPanel, 
{
 initComponent : function()
 {
  ...
  //
  FuzeIn.TerminologyTemplateForm.superclass.initComponent.call(this);
 }
});

//
Ext.reg('fuzein_terminology_template_form', FuzeIn.TerminologyTemplateForm);
