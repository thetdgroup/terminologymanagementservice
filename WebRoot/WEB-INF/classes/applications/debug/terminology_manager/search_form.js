...
FuzeIn.TerminologySearchForm = function(config) 
{
 this.addEvents({
   "search_event":true
 });
 ...
 FuzeIn.TerminologySearchForm.superclass.constructor.call(this, config);
};

//
FuzeIn.TerminologySearchForm = Ext.extend(Ext.form.FormPanel, 
{
 initComponent : function()
 {
  ...
  //
  FuzeIn.TerminologySearchForm.superclass.initComponent.call(this);
 }
});

//
Ext.reg('fuzein_terminology_search_form', FuzeIn.TerminologySearchForm);
